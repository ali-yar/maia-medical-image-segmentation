...
%  struct('Datatype','single', 'BitsPerPixel',32, ...
%     'SpaceUnits','Unknown', 'TimeUnits','None', ...
%     'AdditiveOffset',0, 'MultiplicativeScaling',1, ...
%     'TimeOffset',0, 'SliceCode','Unknown', ...
%     'FrequencyDimension',0, 'PhaseDimension',0, ...
%     'SpatialDimension',0, 'DisplayIntensityRange',[0 0], ...
%     'TransformName','Sform', 'Transform',metaTransform, ...
%     'Qfactor',-1, 'raw',metaRaw);
